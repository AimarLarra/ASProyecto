<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
    	...
    	$checkUserQuery = "SELECT * FROM `usuarios` WHERE `correo` = '$correo'";
    	$result = $con->query($checkUserQuery);

    	if ($result->num_rows > 0) {
        	// User already exists, handle accordingly (display error message, redirect, etc.)
        	echo '<div class="error-message">Ya existe un usuario con este email o nombre!</div>';
    	} else {
        	// User does not exist, proceed with registration
        	$insertUserQuery = "INSERT INTO `usuarios` (`nombre`, `correo`, `contrasena`) VALUES ('$nombre', '$correo', '$contrasena')";
			...
			$_SESSION['nombre'] = $_POST['nombre'];
            		...
            		// Registration failed, handle accordingly (display error message, log error, etc.)
            		echo '<div class="error-message">Inserta valores mas cortos!</div>' . $con->error;
        	}
   	}
   }
?>
        ...
        <main class="tm-main">        
            <div class="row tm-row tm-mb-120">
                ...
                <div class="col-lg-7 tm-contact-left">
                    <form id="formulario" name="formulario" method="POST" action="index.php" class="mb-5 ml-auto mr-0 tm-contact-form">  
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input class="form-control mr-0 ml-auto" name="correo" id="correo" type="text" required>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
